...
const FormBuilder = ({
  ...
  const submissionHandler = data => {
    if(!isEmpty(formSharedState.uploadActions)) {
      for (const fieldKey in formSharedState.uploadActions) {
        if(formSharedState.uploadActions[fieldKey].oldFilesValue) {
          formSharedState.uploadActions[fieldKey].setFilesValue(formSharedState.uploadActions[fieldKey].newFilesValue)
          formSharedState.uploadActions[fieldKey].setNewFiles(formSharedState.uploadActions[fieldKey].newFilesValue)
          if(!isEmpty(formSharedState.uploadActions[fieldKey].oldFilesValue)){ 
            formSharedState.uploadActions[fieldKey].addFileToDelete(formSharedState.uploadActions[fieldKey].oldFilesValue[0]._id)
          }
        }
      } 
    }
